const formatMoney = (value, min = 0, max = 1000000000) => {
    ...
    return [...limited]
      ...
      .replace(/^(\d{1,3})(\d{3})(\d{3})(\d{2})$/, "R$ $1.$2.$3,$4") // Format the number like ###.###.###,##%
      .replace(/^(\d{1,3})(\d{3})(\d{2})$/, "R$ $1.$2,$3") // Format the number like ###.###,##%
      .replace(/^(\d{1,3})(\d{2})$/, "R$ $1,$2") // Format the number like ###,##%
      .replace(/^(\d{2})$/, "R$ 0,$1") // Format the number like 0,##%
      .replace(/^(\d)$/, "R$ 0,0$1"); // Format the number like 0,0#%
  };
